...
export class ForgotPasswordService {
  ...
  forgotPassword(forgotPassword: ForgotPasswordInterface): Observable<ResponseInterface> {
    return this.http.put<ResponseInterface>(`${this.API_DOMAIN}/api/forgot-password`, forgotPassword)
      .pipe(

...
export class ContactService {
    ...
    submit(contactObj: ContactInterface): Observable<ResponseInterface> {
        return this.http.post<ResponseInterface>(`${this.API_DOMAIN}/api/contact`, contactObj, httpOptions)
            .pipe(

...
export class ControlsService implements OnInit {
  ...
  archive(archive: any): Observable<ResponseInterface> {
    return this.http.put<ResponseInterface>(`${this.API_DOMAIN}/api/task/archive`, archive, httpOptions)
      .pipe(

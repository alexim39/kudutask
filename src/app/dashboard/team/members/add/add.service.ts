...
export class AddService {
  ...
  add(membersObj: AddMemberInterface): Observable<ResponseInterface> {
    return this.http.put<ResponseInterface>(`${this.API_DOMAIN}/api/team/add`, membersObj, httpOptions)
      .pipe(

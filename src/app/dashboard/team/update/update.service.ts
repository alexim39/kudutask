...
export class UpdateService {
  ...
  update(updateObj: UpdateTeamInterface): Observable<ResponseInterface> {
    return this.http.put<ResponseInterface>(`${this.API_DOMAIN}/api/team/`, updateObj, httpOptions)
      .pipe(

...
export class PasswordService {
  ...
  changePassword(passwords: ChangePasswordInterface): Observable<ResponseInterface> {
    return this.http.put<ResponseInterface>(`${this.API_DOMAIN}/api/password`, passwords, httpOptions)
      .pipe(

...
export class FeedbackService {
  ...
  // create new feedback
  create(feedbackObj: FeedbackInterface): Observable<ResponseInterface> {
    return this.http.post<ResponseInterface>(`${this.API_DOMAIN}/api/feedback`, feedbackObj, httpOptions)
      .pipe(
